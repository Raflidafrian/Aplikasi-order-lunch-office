<div>
    <button type="button" class="{{ $id ? 'btn-info btn-sm' : 'btn-primary' }}" data-toggle="modal" data-target="#formProduct{{ $id ?? '' }}">
        @if ($id)
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="form-group my-1 d-flex flex-column">
                ...
                <small class="text-secondary -mt-2">Jika Aktif maka product akan ditampilkan di halaman kasir</small>
              </div>
            </div>
