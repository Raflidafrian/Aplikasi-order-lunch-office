...
<div class="card">
    ...
    <div class="card-body">
        ...
        <p class="m-0">Jumlah Bayar     : <strong>Rp. {{ number_format($data->bayar, 0, ',', '.') }}</strong></p>
        <p class="m-0">Kembalian        : <strong>Rp. {{ number_format($data->kembalian, 0, ',', '.') }}</strong></p>
        <P class="m-0">Total Harga      : <strong>Rp. {{ number_format($data->total_harga, 0, ',', '.') }}</strong></P>
